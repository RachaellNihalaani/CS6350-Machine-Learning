#Decision Trees - ID3 Algorithm - Car Evaluation Task (Categorical Variables)
...
#Reading datasets
train_data = pd.read_csv("Car/train.csv",names=col_names)
test_data = pd.read_csv("Car/test.csv",names = col_names)
